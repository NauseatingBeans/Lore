...
This repository serves as the official archive of **Cambridge Lore™**, documenting major historical events such as:

* The discovery of the city's hidden Crack reserves
* The rise of the mysterious **P&H Milling Group**
...
New lore contributions are welcome.

When submitting additions, please ensure they meet at least one of the following criteria:

* Historically impossible
* Scientifically irresponsible
* Narratively questionable
* Funny enough to justify existing

---

## 📜 Canon Policy

Everything is canon until something funnier replaces it.

---

## 📄 License

This project is released under the **Trust Me Bro License (TMBL) v1.0**.
